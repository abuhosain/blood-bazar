    ...
    <div className={font.karla.className}>
      <div className="container mx-auto px-4 xl:px-0">
        ...
        <p className="text-center text-xl font-semibold">
          There are many ways you can contribute to our mission of saving lives
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-6 xl:gap-10">
          {missions.map((mission, index) => (
            <div
              ...
              className="p-5 rounded-lg w-full shadow-2xl"
            >
              <Image
                className="w-full"
                src={mission.img}
              ...
              <p className="text-xl text-justify my-4">{mission.description}</p>
              <div className="flex justify-end">
                <Button
                  btn_primary={false}
                  text="Learn More"
                  styles="bg-[#FF6969] text-white hover:bg-white border hover:border hover:border-black hover:text-black"
                />
              </div>
            </div>
          ))}
